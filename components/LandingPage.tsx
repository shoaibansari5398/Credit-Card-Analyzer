  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans relative overflow-hidden">
      ...
      <main className="relative z-10 flex-grow flex flex-col items-center justify-center text-center px-4 -mt-10">
        ...
        <h1 className="text-5xl md:text-7xl font-bold text-gray-900 tracking-tight leading-[1.1] mb-6 max-w-4xl animate-slide-up" style={{ animationDelay: '0.2s' }}>
            Your Credit Card <br/>
            <span className="text-emerald-500">Financial Story</span> <br/>
            Visualized
        </h1>

        <p className="text-gray-500 text-lg md:text-xl max-w-2xl mb-10 leading-relaxed animate-slide-up" style={{ animationDelay: '0.3s' }}>
