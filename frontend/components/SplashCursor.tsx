...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function updateFrame() {
      ...
      step(dt);
      render(null);
      updateFrameId = requestAnimationFrame(updateFrame);
    }
    ...
    // Initial mouse move to trigger random color logic (optional, kept from original)
    // We can't easily clean this one up if it's a one-time thing, but we can try
    // to incorporate it or just let it be since it removes itself.
    // For safety, let's keep it simple or strictly manage it.
